...
<body>
				...
				<div class="col-lg-4 col-md-6 mb-4">
					<div class="card">
						...
						<div class="card-body">
							...
							<form action="${pageContext.request.contextPath}/cart-addProduct/${product.id()}" method="post" class="row row-cols-lg-auto g-3 flex-nowrap">
	<div class="col-12">
	...
	<div class="col-12 flex-shrink-1">
		<div class="input-group mb-3">
			...
			<input type="text" name="quantity" class="form-control" placeholder="Qty" aria-label="Qty" aria-describedby="basic-addon1">
		</div>
	</div>
</form>
