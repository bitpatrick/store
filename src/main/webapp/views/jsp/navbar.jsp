		...
		<%-- 				<li class="nav-item"><a class="nav-link" href="${pageContext.servletContext.contextPath}/purchase">Purchase</a></li> --%>
						...
						<li class="nav-item dropdown">
				          	...
				          	<ul class="dropdown-menu">
				          		<c:forEach var="locale" items="${locales}" varStatus="status">
								    <li>
								        <a class="dropdown-item" href="#" data-locale="${locale.language}">${locale.getDisplayLanguage()}</a>
								    </li>
						...
						<sec:authorize access="isAuthenticated()">
							...
							<li class="nav-item ms-auto">
								<a class="nav-link active" aria-current="page" href="${pageContext.servletContext.contextPath}/logout">
									Logout
								</a>
							</li>
